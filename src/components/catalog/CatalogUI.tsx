  ...
  return (
    <div className="absolute inset-0 pointer-events-none z-30 flex flex-col justify-between pb-8">
      ...
      <div className="pt-24 px-8 md:px-16 pointer-events-auto flex justify-center">
        <div className="flex space-x-8 md:space-x-16 border-b border-[color:var(--border)] pb-4">
      ...
      <div className="px-8 md:px-16 pointer-events-auto flex flex-col md:flex-row items-end justify-between gap-8">
        ...
        <div className="text-left w-full md:w-1/3">
           <h2 className="text-3xl md:text-5xl font-serif text-foreground tracking-wide leading-tight">
             {activeArtwork.title}
           </h2>
           <p className="text-[color:var(--foreground-soft)] font-light mt-3 max-w-sm text-sm md:text-base">
           ...
           <button className="mt-6 flex items-center gap-2 bg-foreground text-background px-8 py-3 rounded-none font-bold uppercase tracking-widest text-xs hover:opacity-90 transition-colors">
            ...
            <button
              ...
              className={cn(
                ...
                art.id === activeArtworkId
                  ? "border-foreground scale-105 opacity-100 shadow-[0_0_20px_var(--shadow-color)]"
                  : "border-[color:var(--border)] opacity-40 grayscale hover:grayscale-0 hover:opacity-80"
              )}
            >
