...
export function Decision() {
  return (
    <section className="relative h-screen w-full flex flex-col md:flex-row">
      ...
      <Link 
        href="/colecciones"
        className="group relative flex-1 h-full flex flex-col items-center justify-center bg-background border-r border-[color:var(--border)] overflow-hidden transition-all duration-700 hover:flex-[1.5]"
      >
      ...
      <Link 
        ...
        className="group relative flex-1 h-full flex flex-col items-center justify-center bg-[color:var(--surface)] text-foreground overflow-hidden transition-all duration-700 hover:flex-[1.5]"
      >
        <div className="absolute inset-0 bg-[color:var(--overlay-soft)] opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
        <div className="relative z-10 flex flex-col items-center text-center p-8">
